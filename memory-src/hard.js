...
const arr = [
  ...
  {"src": require("./images/kangaroo (1).png"), matched: false },
  {"src": require("./images/wolf.png"), matched: false },
  {"src": require("./images/cool.png"), matched: false },
  {"src": require("./images/flamingo.png"), matched: false },
  {"src": require("./images/panda.png"), matched: false },
  {"src": require("./images/pig.png"), matched: false },
  {"src": require("./images/chicken.png"), matched: false },
  {"src": require("./images/sheep.png"), matched: false },
]
...
function Easy() {
  ...
  // if(arr.map((card) => ({...arr, matched: true}))){
  //   alert("Well Done")
  // }
